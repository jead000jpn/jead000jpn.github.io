...
tinymce.init({
  ...
  content_css: [
    '//transtemple.github.io/aaFont/aaFont.css'
  ],
  body_class: 'AA_Text',
...
var _save_file_name_filter = function (_file_name, _file_format) {
	...
	else if (_file_format === "png") {
        if (_file_name.endsWith(".odt") === false) {
            _file_name = _file_name + ".png";
        }
    }
...
var _save_file_content_filter = function (_file_content, _file_name) {
	...
	return '<html><div style="display: none;"><link rel="stylesheet" type="text/css" href="https://transtemple.github.io/aaFont/aaFont.css"></div><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>' + _file_name +'</title></head>' 
            + '<body class="AA_Text">' + _file_content + '</body>'
            + '</html>';
};
